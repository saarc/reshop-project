...
# cryptogen, configtxgen 바이너리를 참조하기 위한 PATH경로 추가
export PATH=~/fabric-samples/bin:$PATH
# configtxgen -> configtx.yaml 찾아갈때 사용하는 환경변수
export FABRIC_CFG_PATH=${PWD}

CHANNEL_NAME=rechannel #-> papernet
...
# generate genesis block for orderer configtx.yaml <- FABRIC_CFG_PATH
